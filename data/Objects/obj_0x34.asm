...
Offset_0x013C12:
                move.b  #$34, $0000(A1)
                move.b  (A2)+, $0024(A1)
                move.l  #Title_Cards_Mappings, $0004(A1)       ; Offset_0x014758
                move.b  (A2)+, $001A(A1)
                move.b  (A2)+, $0019(A1)
                move.b  (A2)+, $001E(A1)
                move.w  (A2), $0008(A1)
...
Offset_0x013D78:
                jsr     Offset_0x013CAC(PC)
                move.b  (Level_Id).w, $001A(A0)                      ; $FFFFFE10
...
Offset_0x013E82:
                move.l  A0, -(A7)
                move.l  D7, -(A7)
                bsr     Background_Scroll_Layer                ; Offset_0x00C3AC
                move.l  (A7)+, D7
                move.l  (A7)+, A0
                addq.b  #$02, $0024(A0)
                move.w  #$00F0, $0034(A0)
...
Offset_0x013EDE:
                ...
                moveq   #$00, D0
                move.b  (Level_Id).w, D0                             ; $FFFFFE10
                move.b  Flickies_Select_Array(PC, D0), D0      ; Offset_0x013F00
                jsr     (LoadPLC)                              ; Offset_0x0015DA
Offset_0x013EFC:
                bra     DeleteObject                           ; Offset_0x01646C  
;-------------------------------------------------------------------------------                                                   
Flickies_Select_Array: ; Offset_0x013F00:                
                dc.b    $32, $32, $32, $32, $34, $34, $34, $34, $36, $36, $37, $33, $39, $3A, $35, $3B
                dc.b    $38, $38                                       
;===============================================================================
; Objeto 0x34 - Tela com o nome das fases conhecido também conhecido como: 
; [ Término ]        - Splash Screen, Title Cards, etc... 
;===============================================================================  